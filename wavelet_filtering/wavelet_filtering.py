...
# Анализ корреляции
correlation_matrix = np.corrcoef(merged_data['btc_close'], merged_data['eth_close'])
...
# Разделение движений
eth_data_df["eth_close_filtered"] = eth_data_df["eth_close"] - beta_btc * btc_data_df["btc_close"]

# Запись данных в новую таблицу eth_data_filtered
eth_data_df.to_sql("eth_data_filtered", engine, if_exists="replace", index=False)